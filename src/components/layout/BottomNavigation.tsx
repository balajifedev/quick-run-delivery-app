...
import { Home, Search, Package, User, Bike } from "lucide-react";
...
const BottomNavigation: React.FC = () => {
  ...
  const navItems = isDriverRoute 
    ? [
        { path: "/", icon: <Home size={24} />, label: "Home" },
        { path: "/driver", icon: <Bike size={24} />, label: "Dashboard" },
      ...
      {navItems.map((item) => {
        ...
        return (
          ...
          >
            ...
            {item.label === "Orders" && cartItemCount > 0 && !isDriverRoute && (
